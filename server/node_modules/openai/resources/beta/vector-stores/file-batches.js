...
class FileBatches extends resource_1.APIResource {
    ...
    listFiles(batchID, params, options) {
        ...
        return this._client.getAPIList(`/vector_stores/${vector_store_id}/file_batches/${batchID}/files`, (pagination_1.CursorPage), { query, ...options, headers: { 'OpenAI-Beta': 'assistants=v2', ...options?.headers } });
    }
    /**
